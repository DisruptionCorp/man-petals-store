...
describe('Order Routes', () => {
  ...
  describe('/api/orders/', () => {
    ...
    describe('/api/orders/:id', () => {
      it('/DELETE responds with 200, destroys order, and responds with all orders after destruction', async () => {
  ...
  describe('error handling', () => {
    it('responds with a 404 if a order does not exist', async () => {
      await supertest.get('/api/orders/56').expect(404);
    });
  });
});
